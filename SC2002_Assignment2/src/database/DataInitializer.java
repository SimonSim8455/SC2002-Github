...
public class DataInitializer {
	...
	private static void initializeShowStatus() {
		...
		MovieType type1 = MovieType.IMAX;
	...
	private static void initializeUser() {
		UserAccountMgr.createUserAccount("Kid","12","1234-10","test1@gmail.com",12);
		UserAccountMgr.createUserAccount("Elder","34","1234-10","test2@gmail.com",70);
		UserAccountMgr.createUserAccount("Man","56","1234-10","test3@gmail.com",35);
	}
